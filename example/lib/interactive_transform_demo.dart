...
class InteractiveTransformDemo extends StatefulWidget {
  ...
  @override
  State<InteractiveTransformDemo> createState() =>
      _InteractiveTransformDemoState();
}
...
class _InteractiveTransformDemoState extends State<InteractiveTransformDemo> {
  ...
  // Keep track of the last transform classes
  String? _lastTransformClasses;
  ...
  void initState() {
    super.initState();
    // Log initial transform classes
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final transformClasses = _buildTransformClasses();
      _lastTransformClasses = transformClasses;
      debugPrint("Initial transformClasses: $transformClasses");
    });
  }

  void _logTransformClassesIfChanged(String newTransformClasses) {
    if (_lastTransformClasses != newTransformClasses) {
      _lastTransformClasses = newTransformClasses;
      debugPrint("transformClasses changed to: $newTransformClasses");
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Schedule the change check for after the frame is built
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _logTransformClassesIfChanged(transformClasses);
    });
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSlider('Scale (both axes)', scaleValue, 0.5, 2.0,
                    (value) {
                ...
                _buildSlider('Rotate (degrees)', rotateValue, -180, 180,
                    (value) {
                ...
                _buildSlider('Translate X (pixels)', translateXValue, -100, 100,
                    (value) {
                  setState(() => translateXValue = value);
                }),
                _buildSlider('Translate Y (pixels)', translateYValue, -100, 100,
                    (value) {
